...
$stmt = $db->prepare("SELECT *  FROM descuento where id=".$id);
$stmt->execute();
...
<div class="container-fluid">
	<ol class="breadcrumb">
		...
		<li><a class="ajax-request" href="/inventario/descuento/descuento.php">Descuento</a></li>
    <li><a class="active" href="#">Impuesto Editar</a></li>
	</ol>
</div>
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="col-md-4">
            <form method="post" action="descuentoactualizar.php" id="formulario">
              <div class="col-sm-12">
              ...
              <div class="col-sm-6">
                ...
                <input type="number" name="porcentaje" id="precio" required step="any" class="form-control"  value="<?php echo $porcentaje; ?>" />
              </div>
              <div class="col-sm-12">
...
$(document).submit(function( event ) {
  ...
  $.ajax({
    type:"POST",
    url:  './controlador/descuentoactualizar.php',
