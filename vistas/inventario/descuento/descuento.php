  ...
  <div class="row">
    <div class="col-md-12">
      <h3 class="page-header">
        <a class="btn btn-primary ajax-request" href="/inventario/descuento/descuentonuevo.php">
            ...
            <table class="table table-striped table-condensed" id="datos">
              ...
              <tbody>
                ...
                do{
                  ...
                  echo '<td>
                  <a class="btn btn-primary ajax-request" href="/inventario/descuento/descuentoeditar.php?id='.$fila[0].'">
                  <i class="fa fa-pencil"></i>
                  </a>
                  <a class="btn btn-success ajax-request" href="/inventario/descuento/descuentoconsultar.php?id='.$fila[0].'">
                  <i class="fa fa-search"></i>
                  </a>
                  <a class="btn btn-danger ajax-request" href="/inventario/descuento/descuentoeliminar.php?id='.$fila[0].'">
